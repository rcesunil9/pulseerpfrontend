...
const FBAStockDashboard = () => {
  return (
    <div> <table class="table dashboardtable table-hover bg-primary auto-resize -10 mt-2">
    <thead>
      <tr>
        <th scope="col">#</th>

        <th scope="col">Refill Stock days-50/JTL/ FBM SKU/ Bundle</th>

        <th scope="col">Minimum Stock range-25 FBA SKU</th>
